...
const reviewsData = {
  all: [
    ...
    { name: "Robert Brown", role: "Business Analyst", rating: 4.3, comment: "Quick service and delicious meals.", image: "./assets/images/reviews/m5.jpg" }
  ],
  india: [
    { name: "Amit Kumar", role: "Software Engineer", rating: 4.5, comment: "Amazing service and great ambiance.", image: "./assets/images/reviews/m1.jpg" },
  ...
  china: [
    ...
    { name: "Sun Mei", role: "Doctor", rating: 4.2, comment: "Good food and fast service.", image: "./assets/images/reviews/f11.jpg" }
  ],
  japan: [
    { name: "Sakura Yamamoto", role: "Marketing Manager", rating: 3.9, comment: "The atmosphere is very cozy and welcoming.", image: "./assets/images/reviews/f2.jpg" },
